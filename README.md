...
AI 기반 개발자 실력 평가 플랫폼 - "흑백요리사" 안성재 쉐프의 살벌한 코드 리뷰

## 프로젝트 개요

사용자가 GitHub에서 자신있는 프로젝트를 업로드하면, 여러 AI 모델로 코드를 다각도로 분석하여 1-5 레벨로 평가하고, "안성재 쉐프" 페르소나로 살벌하고 재미있는 리뷰를 제공합니다.
...
3. **beomi/OPEN-SOLAR-KO-10.7B** - 안성재 쉐프 페르소나 리뷰 생성
